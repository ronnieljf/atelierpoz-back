/**
 * Script para crear 100 productos de prueba CON IMÁGENES EN VARIANTES
 * Ejecutar con: node src/db/scripts/create_test_products_with_variant_images.js
 */
...
const PRODUCT_TYPES = {
  anillo: {
    ...
    // Mapeo de colores a imágenes (usaremos la imagen base para todas, pero podrías tener diferentes)
    colorImages: {
      'Plata': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/anillo.webp',
      'Oro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/anillo.webp',
      'Oro Rosa': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/anillo.webp',
      'Negro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/anillo.webp',
      'Blanco': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/anillo.webp',
    },
  },
  argolla: {
    ...
    materials: ['Plata 925', 'Oro 18k', 'Acero Inoxidable', 'Titanio'],
    colorImages: {
      'Plata': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/argolla.jpg',
      'Oro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/argolla.jpg',
      'Oro Rosa': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/argolla.jpg',
      'Negro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/argolla.jpg',
      'Blanco': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/argolla.jpg',
    },
  },
  collar: {
    ...
    colorImages: {
      'Plata': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/collar.avif',
      'Oro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/collar.avif',
      'Oro Rosa': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/collar.avif',
      'Negro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/collar.avif',
      'Blanco': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/collar.avif',
    },
  },
  zarcillos: {
    ...
    materials: ['Plata 925', 'Oro 18k', 'Acero Inoxidable', 'Titanio'],
    colorImages: {
      'Plata': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/zarcillos.webp',
      'Oro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/zarcillos.webp',
      'Oro Rosa': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/zarcillos.webp',
      'Negro': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/zarcillos.webp',
      'Blanco': 'https://pub-f8968a35b43a43799c31c2ba7be6cfb1.r2.dev/tests/zarcillos.webp',
    },
  },
};
...
// Función para generar atributos con imágenes en variantes según el tipo de producto
  ...
  if (productType === 'anillo' || productType === 'argolla') {
    ...
    attributes.push({
      ...
      variants: typeConfig.sizes.map((size, idx) => ({
        ...
        sku: `T-${size}`,
        // Las tallas no tienen imágenes específicas
      })),
    });

    // Color (usar tipo 'color' según el frontend) - CON IMÁGENES
    attributes.push({
      id: `attr-${timestamp}-2`,
      name: 'color',
      type: 'color',
      ...
      variants: typeConfig.colors.slice(0, 3).map((color, idx) => ({
        id: `var-${timestamp}-${idx + 10}`,
        name: color,
        value: color,
        stock: randomInt(5, 30),
        sku: `C-${color.substring(0, 2).toUpperCase()}`,
        // Agregar imagen específica para esta variante de color
        images: [typeConfig.colorImages[color] || typeConfig.image],
      })),
    });
    ...
    attributes.push({
      ...
      variants: typeConfig.lengths.map((length, idx) => ({
        ...
        sku: `L-${length}`,
        // Las longitudes no tienen imágenes específicas
      })),
    });
    ...
    attributes.push({
      ...
      variants: typeConfig.types.slice(0, 3).map((type, idx) => ({
        ...
        // Los tipos pueden tener imágenes (usaremos la imagen base)
        images: [typeConfig.image],
      })),
    });
...
async function createTestProducts() {
  console.log('🚀 Iniciando creación de productos de prueba CON IMÁGENES EN VARIANTES\n');
  ...
  try {
    ...
    try {
      ...
      console.log('\n📦 Creando productos CON IMÁGENES EN VARIANTES...\n');
      ...
      console.log(`   - ✨ Variantes con imágenes: SÍ`);
